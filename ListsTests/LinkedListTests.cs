...
namespace ListsTests
{
    class LinkedListTests
    {
        ...
        public void AddLinkedListTest(int[] inputArray, int[] additionalArray, int[] expectedArray)
        {
            LinkedList additionalList = new LinkedList(additionalArray);
            LinkedList expected = new LinkedList(expectedArray);
            LinkedList actual = new LinkedList(inputArray);
            actual.AddLinkedList(additionalList);
            Assert.AreEqual(expected, actual);
        }

        [TestCase(new int[] { 1, 2, 3, 4 })]
        public void AddLinkedList_WhenArgumentIsNull_NullReferenceException(int[] inputArray)
        {
            LinkedList actual = new LinkedList(inputArray);
            try
            {

                actual.AddLinkedList(null);
            }
            catch
            {
                Assert.Pass();
        ...
        [TestCase(new int[0], new int[0], new int[0])]
        public void AddLinkedListAtBeginningTest(int[] inputArray, int[] additionalArray, int[] expectedArray)
        {
            LinkedList additionalList = new LinkedList(additionalArray);
            LinkedList expected = new LinkedList(expectedArray);
            LinkedList actual = new LinkedList(inputArray);
            actual.AddLinkedListAtBeginning(additionalList);
            Assert.AreEqual(expected, actual);
        }

        [TestCase(new int[] { 1, 2, 3, 4 })]
        public void AddLinkedListAtBeginning_WhenArgumentIsNull_NullReferenceException(int[] inputArray)
        {
            LinkedList actual = new LinkedList(inputArray);
            try
            {

                actual.AddLinkedListAtBeginning(null);
            }
            catch
            {
                Assert.Pass();
        ...
        public void AddLinkedListByIndexTest(int[] inputArray, int[] additionalArray, int index, int[] expectedArray)
        {
            LinkedList additionalList = new LinkedList(additionalArray);
            LinkedList expected = new LinkedList(expectedArray);
            LinkedList actual = new LinkedList(inputArray);
            actual.AddLinkedListByIndex(additionalList, index);
            Assert.AreEqual(expected, actual);
        }

        [TestCase(new int[] { 1, 2, 3, 4 }, new int[] { 1, 2 }, 5)]
        [TestCase(new int[] { 1, 2, 3, 4 }, new int[] { 1, 2 }, -4)]
        public void AddLinkedListByIndex_WhenIndexOutOfRange_IndexOutOfRangeException(int[] inputArray, int[] additionalArray, int index)
        {
            LinkedList additionalList = new LinkedList(additionalArray);
            LinkedList actual = new LinkedList(inputArray);
            try
        ...
        public void AddLinkedListByIndex_WhenArgumentIsNull_NullReferenceException(int[] inputArray, int index)
        {
            LinkedList actual = new LinkedList(inputArray);
            try
            {

                actual.AddLinkedListByIndex(null, index);
            }
            catch
            {
                Assert.Pass();
        ...
        public void AllMethodsTest(int[] inputArray, int[] expectedArray)
        {
            ...
            actual.AddLinkedListByIndex(new LinkedList(new int[] { 2, 3, 4, 5 }), 1);
            actual.RemoveValuesByIndex(5, 2);
            actual.Reverse();
            actual.SortAscending();
            actual.SortDescending();
            actual.AddLinkedList(new LinkedList(new int[] { 100, 200 }));
            actual.AddLinkedListAtBeginning(new LinkedList(new int[] { 99, 88, 77 }));
            Assert.AreEqual(expected, actual);
        }
    }
}
